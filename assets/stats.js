...
const request = async () => { // Calling a "synchronous" fetch
    const response = await fetch('https://api3.adsterratools.com/publisher/390c45f7cf0003ba726d098faf170ac7/stats.json?domain=3037818&start_date=2023-01-10&finish_date=2023-12-12&group_by=date',  { mode: 'no-cors'});
